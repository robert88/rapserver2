...
test("makeCallbackFunc 将异步代码转为callback异步方式", () => {

  {
    ...
    let ret = "function(){letb={};leta=1+2;lettest=function(__buildAsyncError__){if(__error__){throw__error__;}letd=1;};lett;test(function(__error__1,__result__1){if(__error__1){throw__error__1;}t=__result__1;if(a){b=1;}test(function(__error__2,__result__2){if(__error__2){throw__error__2;}if(!(__result__2)){b=3;}letobj={test:test};letg='1';letd;obj[\"test\"](function(__error__3,__result__3){if(__error__3){throw__error__3;}d=__result__3;})})})}"
  ...
  // //带参数1
  {
    ...
    let tet = makeCallbackFunc(a1).toString().replace(/\s+/g, "");
    let ret = "function(parama,paramb){letb={};leta=1+2;lettest=function(__buildAsyncError__){if(__error__){throw__error__;}letd=1;};lett;test(function(__error__1,__result__1){if(__error__1){throw__error__1;}t=__result__1;if(a){b=1;}test(function(__error__2,__result__2){if(__error__2){throw__error__2;}if(!(__result__2)){b=3;}letobj={test:test};letg='1';letd;obj[\"test\"](function(__error__3,__result__3){if(__error__3){throw__error__3;}d=__result__3;})})})}"
    //toString会把没有用的()去掉，而！这样会添加（）
    expect(tet).toBe(ret);
  }
